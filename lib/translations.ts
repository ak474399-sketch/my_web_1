...
export type TranslationKeys = {
  ...
  history: {
    ...
    errorSessionNotRecognized: string;
    errorLoadFailed: string;
    errorTableNotReady: string;
    relogin: string;
  };
...
reviewsSection: { title: "What Users Say", subtitle: "Real experiences from people who restored their memories.", cta: "Share your experience →" },
    ...
    history: {
      ...
      errorUnauthorized: "Please sign in to view history.",
      errorSessionInvalid: "Session expired. Please refresh or sign in again.",
      errorSessionNotRecognized: "Sign-in was not recognized. Please sign in again and try again.",
      errorLoadFailed: "Failed to load history. Please try again later.",
      errorTableNotReady: "History is not ready yet. Please try again later or contact support.",
    ...
    member: {
      ...
      giftButton: "Claim welcome gift",
      giftClaiming: "Claiming…",
      giftSuccess: "You received 5 bonus points.",
      giftAlreadyClaimed: "You have already claimed the welcome gift.",
      giftError: "Failed to claim. Please try again later.",
      giftUnauthorized: "Please sign in to claim the gift.",
    },
  ...
  "zh-CN": {
    ...
    history: { loadingHistory: "正在加载历史…", signInToSeeHistory: "登录后可查看历史", signInToSeeHistoryDesc: "登录后修复的照片会保存在这里。", restorationHistory: "修复历史", photosRestoredWhileSignedIn: "您登录后修复的照片。", noRestorationsYet: "暂无修复记录。登录后修复一张照片即可在此查看。", restoreAPhoto: "修复一张照片", beforeAfter: "修复前 / 修复后", errorUnauthorized: "请先登录后查看历史。", errorSessionInvalid: "登录已失效，请刷新页面或重新登录。", errorSessionNotRecognized: "登录状态未生效，请重新登录后再试。", errorLoadFailed: "加载历史失败，请稍后重试。", errorTableNotReady: "历史记录暂未就绪，请稍后重试或联系客服。", relogin: "重新登录" },
  ...
  "zh-TW": {
    ...
    history: { loadingHistory: "正在載入歷史…", signInToSeeHistory: "登入後可查看歷史", signInToSeeHistoryDesc: "登入後修復的照片會儲存在這裡。", restorationHistory: "修復歷史", photosRestoredWhileSignedIn: "您登入後修復的照片。", noRestorationsYet: "暫無修復記錄。登入後修復一張照片即可在此查看。", restoreAPhoto: "修復一張照片", beforeAfter: "修復前 / 修復後", errorUnauthorized: "請先登入後查看歷史。", errorSessionInvalid: "登入已失效，請重新整理或重新登入。", errorSessionNotRecognized: "登入狀態未生效，請重新登入後再試。", errorLoadFailed: "載入歷史失敗，請稍後重試。", errorTableNotReady: "歷史記錄暫未就緒，請稍後重試或聯絡客服。", relogin: "重新登入" },
  ...
  es: {
    ...
    history: { loadingHistory: "Cargando historial…", signInToSeeHistory: "Inicia sesión para ver tu historial", signInToSeeHistoryDesc: "Tus fotos restauradas se guardan aquí tras iniciar sesión.", restorationHistory: "Historial de restauración", photosRestoredWhileSignedIn: "Fotos que has restaurado con la sesión iniciada.", noRestorationsYet: "Aún no hay restauraciones. Restaura una foto con la sesión iniciada para verla aquí.", restoreAPhoto: "Restaurar una foto", beforeAfter: "Antes / Después", errorUnauthorized: "Inicia sesión para ver el historial.", errorSessionInvalid: "Sesión caducada. Actualiza o inicia sesión de nuevo.", errorSessionNotRecognized: "La sesión no se reconoció. Inicia sesión de nuevo.", errorLoadFailed: "No se pudo cargar el historial. Inténtalo más tarde.", errorTableNotReady: "El historial no está listo. Inténtalo más tarde.", relogin: "Iniciar sesión de nuevo" },
  ...
  pt: {
    ...
    history: { loadingHistory: "Carregando histórico…", signInToSeeHistory: "Entre para ver seu histórico", signInToSeeHistoryDesc: "Suas fotos restauradas são salvas aqui após entrar.", restorationHistory: "Histórico de restauração", photosRestoredWhileSignedIn: "Fotos que você restaurou com a sessão iniciada.", noRestorationsYet: "Ainda não há restaurações. Restaure uma foto com a sessão iniciada para aparecer aqui.", restoreAPhoto: "Restaurar uma foto", beforeAfter: "Antes / Depois", errorUnauthorized: "Entre para ver o histórico.", errorSessionInvalid: "Sessão expirada. Atualize ou entre novamente.", errorSessionNotRecognized: "Login não reconhecido. Entre novamente.", errorLoadFailed: "Falha ao carregar o histórico. Tente mais tarde.", errorTableNotReady: "O histórico ainda não está disponível. Tente mais tarde.", relogin: "Entrar novamente" },
  ...
  ar: {
    ...
    history: { loadingHistory: "جاري تحميل السجل…", signInToSeeHistory: "سجّل الدخول لعرض سجلك", signInToSeeHistoryDesc: "صورك المستعادة تُحفظ هنا بعد تسجيل الدخول.", restorationHistory: "سجل الاستعادة", photosRestoredWhileSignedIn: "الصور التي استعدتها أثناء تسجيل الدخول.", noRestorationsYet: "لا استعادة بعد. استعد صورة أثناء تسجيل الدخول لتظهر هنا.", restoreAPhoto: "استعادة صورة", beforeAfter: "قبل / بعد", errorUnauthorized: "سجّل الدخول لعرض السجل.", errorSessionInvalid: "انتهت الجلسة. حدّث الصفحة أو سجّل الدخول مرة أخرى.", errorSessionNotRecognized: "لم يتم التعرف على تسجيل الدخول. سجّل الدخول مرة أخرى.", errorLoadFailed: "فشل تحميل السجل. جرّب لاحقاً.", errorTableNotReady: "السجل غير متاح بعد. جرّب لاحقاً.", relogin: "تسجيل الدخول مرة أخرى" },
